...
worker_processes(1)
preload_app true
user('hosting_archgroup','plex_users')
timeout 40
listen '/var/sockets/arch-group.archgroup.sock'
working_directory '/home/hosting_archgroup/projects/arch-group/current'
pid '/var/run/unicorn/arch-group.archgroup.pid'
stderr_path "/home/hosting_archgroup/projects/arch-group/current/log/unicorn.log"
stdout_path "/home/hosting_archgroup/projects/arch-group/current/log/unicorn.log"
